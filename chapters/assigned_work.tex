...
\begin{enumerate}
    ...
    \item \textbf{Role} เป็นชุดสิทธิการใช้งานที่ระบุถึงการเข้าถึงหรือการทำงานที่ผู้ใช้หรือกลุ่มผู้ใช้สามารถทำได้ โดย Role จะแบ่งออกเป็นสองประเภท ได้แก่ Client Role ซึ่งเชื่อมโยงกับบริการเฉพาะ และ Realm Role
